...
PerformAutofocusDOF = function()
    ...
    local currentCamera_far_plane = AgentSetProperty(currentCamera_name, "Clip Plane - Far", Custom_DOF_AUTOFOCUS_SceneObject); --Number type
    local currentCamera_near_plane = AgentSetProperty(currentCamera_name, "Clip Plane - Near", Custom_DOF_AUTOFOCUS_SceneObject); --Number type
    ...
    for i, objectName in ipairs(Custom_DOF_AUTOFOCUS_ObjectEntries) do
        ...
        if (object_agent) then
            ...
            object_isVisible = AgentSetProperty(objectName, "Runtime: Visible", Custom_DOF_AUTOFOCUS_SceneObject);
    ...
    if (Custom_DOF_AUTOFOCUS_UseCameraDOF == true) then
        ...
        AgentSetProperty(currentCamera_name, "Depth Of Field Enabled", current_enabledDOF, Custom_DOF_AUTOFOCUS_SceneObject)
		
		AgentSetProperty(currentCamera_name, "Depth Of Field - Far", current_farFocusDistance, Custom_DOF_AUTOFOCUS_SceneObject)
		AgentSetProperty(currentCamera_name, "Depth Of Field Fall Off - Far", current_farFalloff, Custom_DOF_AUTOFOCUS_SceneObject)
		AgentSetProperty(currentCamera_name, "Depth Of Field Max - Far", current_farMax, Custom_DOF_AUTOFOCUS_SceneObject)
		
	    AgentSetProperty(currentCamera_name, "Depth Of Field - Near", current_nearFocusDistance, Custom_DOF_AUTOFOCUS_SceneObject)
		AgentSetProperty(currentCamera_name, "Depth Of Field Fall Off - Near", current_nearFallof, Custom_DOF_AUTOFOCUS_SceneObject)
		AgentSetProperty(currentCamera_name, "Depth Of Field Max - Near", current_nearMax, Custom_DOF_AUTOFOCUS_SceneObject)
    else
        --Use the DOF properties on the scene post processing itself
        AgentSetProperty(Custom_DOF_AUTOFOCUS_SceneObjectAgentName, "FX DOF Enabled", current_enabledDOF, Custom_DOF_AUTOFOCUS_SceneObject)
		
		AgentSetProperty(Custom_DOF_AUTOFOCUS_SceneObjectAgentName, "FX DOF Far", current_farFocusDistance, Custom_DOF_AUTOFOCUS_SceneObject)
		AgentSetProperty(Custom_DOF_AUTOFOCUS_SceneObjectAgentName, "FX DOF Far Falloff", current_farFalloff, Custom_DOF_AUTOFOCUS_SceneObject)
		AgentSetProperty(Custom_DOF_AUTOFOCUS_SceneObjectAgentName, "FX DOF Far Max", current_farMax, Custom_DOF_AUTOFOCUS_SceneObject)
		
		AgentSetProperty(Custom_DOF_AUTOFOCUS_SceneObjectAgentName, "FX DOF Near", current_nearFocusDistance, Custom_DOF_AUTOFOCUS_SceneObject)
		AgentSetProperty(Custom_DOF_AUTOFOCUS_SceneObjectAgentName, "FX DOF Near Falloff", current_nearFallof, Custom_DOF_AUTOFOCUS_SceneObject)
		AgentSetProperty(Custom_DOF_AUTOFOCUS_SceneObjectAgentName, "FX DOF Near Max", current_nearMax, Custom_DOF_AUTOFOCUS_SceneObject)
    end
