...
Custom_CutsceneDev_CutsceneToolsTextTitle = "CUTSCENE TOOLS BY DAVID M (V1.0)";
...
Custom_CutsceneDev_BuildSceneAgentList = function()
    ...
    for i, sceneAgent in ipairs(allSceneAgents) do
        ...
        local originalVisibility = AgentGetProperty(sceneAgentName, "Runtime: Visible", Custom_CutsceneDev_SceneObject); --bool type
...
Custom_CutsceneDev_InitalizeCutsceneTools = function()
    ...
    AgentSetProperty(Custom_CutsceneDev_SceneObjectAgentName, "FX Vignette Tint Enabled", false, Custom_CutsceneDev_SceneObject);
...
Custom_CutsceneDev_UpdateCutsceneTools_Input = function()
    ...
    -------------------------------------------------------------
    --edit mode toggle
    if Input_IsVKeyPressed(82) then
        --R key
        Custom_CutsceneDev_CutsceneToolsEditMode = false;
        Custom_CutsceneDev_BuildSceneAgentList();
    elseif Input_IsVKeyPressed(70) then
        --F key
        Custom_CutsceneDev_CutsceneToolsEditMode = true;
        Custom_CutsceneDev_BuildSceneAgentList();
    end
...
Custom_CutsceneDev_UpdateCutsceneTools_Main = function()  
    ...
    local currentCamera_fov = AgentGetProperty(currentCamera_name, "Field of View", Custom_CutsceneDev_SceneObject); --number type
