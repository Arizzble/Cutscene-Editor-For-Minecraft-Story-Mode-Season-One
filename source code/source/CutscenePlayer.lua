...
player_resetAnimation = function(ii)
    ...
    --Custom_SetAgentRotation
    --Custom_SetAgentPosition
    --AgentSetRot
    ...
    AgentSetWorldPos(player_agent_name, player_LoadAgentPos, Custom_CutsceneDev_SceneObject);
    local player_LoadAgentRot = Vector(player_save_data[ii].rot_x, player_save_data[ii].rot_y, player_save_data[ii].rot_z);
    AgentSetWorldRot(player_agent_name, player_LoadAgentRot, Custom_CutsceneDev_SceneObject);
    local dummy_name = "Dummy" .. tostring(ii);
    AgentSetWorldPos(dummy_name, Vector(0, 0, 0), Custom_CutsceneDev_SceneObject);
    AgentSetWorldRot(dummy_name, Vector(0, 0, 0), Custom_CutsceneDev_SceneObject);
end
...
--ui_carouselDisplay_title.prop
    ...
    AgentSetProperty("agent_choice_ui_1", "Render Depth Test", false, Custom_CutsceneDev_SceneObject)
    AgentSetProperty("agent_choice_ui_1", "Render Depth Write", false, Custom_CutsceneDev_SceneObject)
    AgentSetProperty("agent_choice_ui_1", "Render Depth Write Alpha", false, Custom_CutsceneDev_SceneObject)
    AgentSetProperty("agent_choice_ui_1", "Render Layer", 95, Custom_CutsceneDev_SceneObject)
    
    --Custom_AgentSetProperty("agent_choice_ui_2", "Render After Anti-Aliasing", true, Custom_CutsceneDev_SceneObject)
    AgentSetProperty("agent_choice_ui_2", "Render Depth Test", false, Custom_CutsceneDev_SceneObject)
    AgentSetProperty("agent_choice_ui_2", "Render Depth Write", false, Custom_CutsceneDev_SceneObject)
    AgentSetProperty("agent_choice_ui_2", "Render Depth Write Alpha", false, Custom_CutsceneDev_SceneObject)
    AgentSetProperty("agent_choice_ui_2", "Render Layer", 95, Custom_CutsceneDev_SceneObject)

    --Custom_AgentSetProperty("agent_choice_ui_3", "Render After Anti-Aliasing", true, Custom_CutsceneDev_SceneObject)
    AgentSetProperty("agent_choice_ui_3", "Render Depth Test", false, Custom_CutsceneDev_SceneObject)
    AgentSetProperty("agent_choice_ui_3", "Render Depth Write", false, Custom_CutsceneDev_SceneObject)
    AgentSetProperty("agent_choice_ui_3", "Render Depth Write Alpha", false, Custom_CutsceneDev_SceneObject)
    AgentSetProperty("agent_choice_ui_3", "Render Layer", 95, Custom_CutsceneDev_SceneObject)

    --Custom_AgentSetProperty("agent_choice_ui_4", "Render After Anti-Aliasing", true, Custom_CutsceneDev_SceneObject)
    AgentSetProperty("agent_choice_ui_4", "Render Depth Test", false, Custom_CutsceneDev_SceneObject)
    AgentSetProperty("agent_choice_ui_4", "Render Depth Write", false, Custom_CutsceneDev_SceneObject)
    AgentSetProperty("agent_choice_ui_4", "Render Depth Write Alpha", false, Custom_CutsceneDev_SceneObject)
    AgentSetProperty("agent_choice_ui_4", "Render Layer", 95, Custom_CutsceneDev_SceneObject)
    
    --attach to camera
    AgentAttach("ui_boot_title", "Arizzblefreecam");
    ...
    --left up
    AgentSetProperty("agent_choice_ui_1", "Render Axis Scale", Vector(1,0.25,1), Custom_CutsceneDev_SceneObject);
    AgentSetPos("agent_choice_ui_1", Vector(5,-3,22), Custom_CutsceneDev_SceneObject)
    AgentSetRot("agent_choice_ui_1", Vector(0,180,0), Custom_CutsceneDev_SceneObject);
    --right up
    AgentSetProperty("agent_choice_ui_2", "Render Axis Scale", Vector(1,0.25,1), Custom_CutsceneDev_SceneObject);
    AgentSetPos("agent_choice_ui_2", Vector(-5,-3,22), Custom_CutsceneDev_SceneObject)
    AgentSetRot("agent_choice_ui_2", Vector(0,180,0), Custom_CutsceneDev_SceneObject);
    --left down
    AgentSetProperty("agent_choice_ui_3", "Render Axis Scale", Vector(1,0.25,1), Custom_CutsceneDev_SceneObject);
    AgentSetPos("agent_choice_ui_3", Vector(5,-5,22), Custom_CutsceneDev_SceneObject)
    AgentSetRot("agent_choice_ui_3", Vector(0,180,0), Custom_CutsceneDev_SceneObject);
    --right down
    AgentSetProperty("agent_choice_ui_4", "Render Axis Scale", Vector(1,0.25,1), Custom_CutsceneDev_SceneObject);
    AgentSetPos("agent_choice_ui_4", Vector(-5,-5,22), Custom_CutsceneDev_SceneObject)
    AgentSetRot("agent_choice_ui_4", Vector(0,180,0), Custom_CutsceneDev_SceneObject);
    ...
    AgentSetPos("agent_choice_ui_text_1", Vector(6.1,-2.71,21), Custom_CutsceneDev_SceneObject)
    AgentSetRot("agent_choice_ui_text_1", Vector(0,180,0), Custom_CutsceneDev_SceneObject);
    ...
    AgentSetPos("agent_choice_ui_text_2", Vector(-3.5,-2.71,21), Custom_CutsceneDev_SceneObject)
    AgentSetRot("agent_choice_ui_text_2", Vector(0,180,0), Custom_CutsceneDev_SceneObject);
    ...
    AgentSetPos("agent_choice_ui_text_3", Vector(6.1,-4.65,21), Custom_CutsceneDev_SceneObject)
    AgentSetRot("agent_choice_ui_text_3", Vector(0,180,0), Custom_CutsceneDev_SceneObject);
    ...
    AgentSetPos("agent_choice_ui_text_4", Vector(-3.5,-4.65,21), Custom_CutsceneDev_SceneObject)
    AgentSetRot("agent_choice_ui_text_4", Vector(0,180,0), Custom_CutsceneDev_SceneObject);
    ...
    AgentSetPos("agent_choice_ui_timer", Vector(7,-6,21), Custom_CutsceneDev_SceneObject)
    AgentSetRot("agent_choice_ui_timer", Vector(0,180,0), Custom_CutsceneDev_SceneObject);
...
CutscenePlayerUpdate = function()
    ...
    if (GetTotalTime() > (player_cutscene_data[player_clip].duration + player_start_time)) or chosen_text > 0 then -- switch to next clip
        ...
        AgentSetWorldPos(agent_name_cutsceneCamera, player_LoadAgentPos, Custom_CutsceneDev_SceneObject);
        ...
        AgentSetWorldRot(agent_name_cutsceneCamera, player_LoadAgentRot, Custom_CutsceneDev_SceneObject);
        ...
        for i = 1, player_n_n do
            ...
            if player_save_data[i].mode == 0 then
                if player_save_data[i].speed == 0 then
                    ...
                    if GetTotalTime() > (move_start_time_pos[i] + player_save_data[i].speed) then
                        ...
                        AgentSetWorldPos(player_agent_name, Position3, Custom_CutsceneDev_SceneObject);    
                    end
                ...
                if player_save_data[i].r_speed == 0 then
                    ...
                    if GetTotalTime() > (move_start_time_rot[i] + player_save_data[i].r_speed) then
                        ...
                        AgentSetWorldRot(player_agent_name, Rotation3, Custom_CutsceneDev_SceneObject);
                    end
                end
            ...
            elseif player_save_data[i].mode == 1 then
                ...
                AgentSetWorldPos(player_agent_name, ControllerPos, Custom_CutsceneDev_SceneObject);
                AgentSetWorldRot(player_agent_name, ControllerRot, Custom_CutsceneDev_SceneObject);
        ...
        if player_save_data.camera.speed == 0 then
            ...
            if GetTotalTime() > (move_start_time_pos_camera + player_save_data.camera.speed) then
                ...
                AgentSetWorldPos(agent_name_cutsceneCamera, Position3, Custom_CutsceneDev_SceneObject);    
            end
        ...
        if player_save_data.camera.r_speed == 0 then
            ...
            if GetTotalTime() > (move_start_time_rot_camera + player_save_data.camera.r_speed) then
                ...
                AgentSetWorldRot(agent_name_cutsceneCamera, Rotation3, Custom_CutsceneDev_SceneObject);
            end
        end
        ...
        if dialogue_mode == 0 then
            if player_cutscene_data[player_clip].choices > 0 then
                if (Input_IsVKeyPressed(83) or Input_IsVKeyPressed(40)) and GetTotalTime() > SwitchDelay_2 then --move down, arrow key or s
                ...
                elseif (Input_IsVKeyPressed(87) or Input_IsVKeyPressed(38)) and GetTotalTime() > SwitchDelay_2 then --move up, arrow key or w
                    dialogue_mode_option = dialogue_mode_option-1;
                ...
                if Input_IsVKeyPressed(1) and GetTotalTime() > SwitchDelay  then
                    if dialogue_mode_option == 1 then
                        chosen_text = 1;
                    elseif dialogue_mode_option == 2 then
                        chosen_text = 2;
    ...
    if player_clip_finished == 0 then
        ...
        --choice UI
            ...
            AgentSetPos("agent_choice_ui_1", Vector(5,-3,-1000), Custom_CutsceneDev_SceneObject)
            AgentSetPos("agent_choice_ui_2", Vector(5,-3,-1000), Custom_CutsceneDev_SceneObject)
            AgentSetPos("agent_choice_ui_3", Vector(5,-3,-1000), Custom_CutsceneDev_SceneObject)
            AgentSetPos("agent_choice_ui_4", Vector(5,-3,-1000), Custom_CutsceneDev_SceneObject)
        ...
        if dialogue_mode == 0 then
            if player_cutscene_data[player_clip].choices > 0 then
                ...
                AgentSetPos("agent_choice_ui_text_1", Vector(choice_text_length,-2.71,21), Custom_CutsceneDev_SceneObject)
                TextSetColor("agent_choice_ui_text_1", Color(1.0, 1.0, 1.0, 1.0));
                if player_cutscene_data[player_clip].choices > 1 then
                    ...
                    AgentSetPos("agent_choice_ui_text_2", Vector(choice_text_length,-3.356,21), Custom_CutsceneDev_SceneObject)
                    TextSetColor("agent_choice_ui_text_2", Color(1.0, 1.0, 1.0, 0.3));
                    if player_cutscene_data[player_clip].choices > 2 then
                        ...
                        AgentSetPos("agent_choice_ui_text_3", Vector(choice_text_length,-4.002,21), Custom_CutsceneDev_SceneObject)
                        TextSetColor("agent_choice_ui_text_3", Color(1.0, 1.0, 1.0, 0.3));
                        if player_cutscene_data[player_clip].choices > 3 then
                            ...
                            AgentSetPos("agent_choice_ui_text_4", Vector(choice_text_length,-4.65,21), Custom_CutsceneDev_SceneObject)
                            TextSetColor("agent_choice_ui_text_4", Color(1.0, 1.0, 1.0, 0.3));
                        end
                    end--1.85
                end
            ...
            if player_cutscene_data[player_clip].choices > 0 then
                ...
                if player_cutscene_data[player_clip].choices > 1 then
                    ...
                    AgentSetPos("agent_choice_ui_text_2", Vector(choice_text_length,-2.71,21), Custom_CutsceneDev_SceneObject)
                    TextSetColor("agent_choice_ui_text_2", Color(1.0, 1.0, 1.0, 1.0));
                    if player_cutscene_data[player_clip].choices > 2 then
                        AgentSetPos("agent_choice_ui_3", Vector(5,-5,22), Custom_CutsceneDev_SceneObject)
                        TextSet(agent_choice_ui_text_3, player_cutscene_data[player_clip].choice3_text);
                        ...
                        AgentSetPos("agent_choice_ui_text_3", Vector(choice_text_length,-4.65,21), Custom_CutsceneDev_SceneObject)
                        TextSetColor("agent_choice_ui_text_3", Color(1.0, 1.0, 1.0, 1.0));
                        if player_cutscene_data[player_clip].choices > 3 then
                            AgentSetPos("agent_choice_ui_4", Vector(-5,-5,22), Custom_CutsceneDev_SceneObject)
                            TextSet(agent_choice_ui_text_4, player_cutscene_data[player_clip].choice4_text);
