...
local Dummy = nil;
--Custom_CutsceneDev_Freecam_InputMouseAmountX
--to change controls
...
ResetAnimation = function()
    ...
    AgentSetWorldPos("Dummy", Vector(0, 0, 0), Custom_CutsceneDev_SceneObject);
    AgentSetWorldRot("Dummy", Vector(0, 0, 0), Custom_CutsceneDev_SceneObject);
    --AgentSetRot
    AgentSetWorldPos(currentAgent_name, Vector(x_x, y_y, z_z), Custom_CutsceneDev_SceneObject);
    AgentSetWorldRot(currentAgent_name, Vector(r_x, r_y, z_y), Custom_CutsceneDev_SceneObject);
end
...
Cutscene_Load_Clip_Set_Coords = function(number_of_the_agent)
    ...
    AgentSetWorldPos(load_agent_name, LoadAgentPos, Custom_CutsceneDev_SceneObject);
    AgentSetWorldRot(load_agent_name, LoadAgentRot, Custom_CutsceneDev_SceneObject);
end
...
move_object = function()
    ...
    if animation_menu == 0 then
        ...
        AgentSetWorldPos(currentAgent_name, Vector(x_x, y_y, z_z), Custom_CutsceneDev_SceneObject);
        AgentSetWorldRot(currentAgent_name, Vector(r_x, r_y, r_z), Custom_CutsceneDev_SceneObject);
    ...
    elseif animation_menu == 1 then
        if mode == 0 then
            if speed == 0 then
                ...
                if GetTotalTime() > (move_start_time_pos + speed) then
                    ...
                    AgentSetWorldPos(currentAgent_name, Position3, Custom_CutsceneDev_SceneObject);    
                end
            ...
            if r_speed == 0 then
                ...
                if GetTotalTime() > (move_start_time_rot + r_speed) then
                    ...
                    AgentSetWorldRot(currentAgent_name, Rotation3, Custom_CutsceneDev_SceneObject);
                end
            end
        ...
        elseif mode == 1 then
            ...
            AgentSetWorldPos(currentAgent_name, ControllerPos, Custom_CutsceneDev_SceneObject);
            AgentSetWorldRot(currentAgent_name, ControllerRot, Custom_CutsceneDev_SceneObject);
        elseif mode == 2 then
    ...
    if GetTotalTime() > modeSwitchTime and Input_IsVKeyPressed(4) then
    ...
    elseif GetTotalTime() > modeSwitchTime and Input_IsVKeyPressed(90) then
        if input_Swith == 0 then
            input_Swith = 1;
            inputText = "";
        else
    ...
    elseif GetTotalTime() > modeSwitchTime and Input_IsVKeyPressed(82) then
        if input_Swith == 0 then
            input_Swith = 3;
            x_x_x = x_x;
            y_y_y = y_y;
    ...
    if input_Swith == 1 then --save input
        ...
        if GetTotalTime() > modeSwitchTime then 
            if Input_IsVKeyPressed(48) then
            ...
            elseif Input_IsVKeyPressed(52) then
                ...
                modeSwitchTime = GetTotalTime() + 0.3;
            elseif Input_IsVKeyPressed(53) then
                inputText = inputText .. "5";
                modeSwitchTime = GetTotalTime() + 0.3;
            elseif Input_IsVKeyPressed(54) then
                inputText = inputText .. "6";
                modeSwitchTime = GetTotalTime() + 0.3;
            elseif Input_IsVKeyPressed(55) then
                inputText = inputText .. "7";
                modeSwitchTime = GetTotalTime() + 0.3;
            elseif Input_IsVKeyPressed(56) then
                inputText = inputText .. "8";
                modeSwitchTime = GetTotalTime() + 0.3;
            elseif Input_IsVKeyPressed(57) then
                inputText = inputText .. "9";
                modeSwitchTime = GetTotalTime() + 0.3;
            elseif Input_IsVKeyPressed(45) then --press Insert (for saving)
                ...
                return
            elseif Input_IsVKeyPressed(46) then --press Delete (for loading)
    ...
    elseif input_Swith == 2 then --camera input
        ...
        --AgentFind
        --AgentFindInScene
        agent_free_camera = AgentFind("Arizzblefreecam", kScene);
        local SaveCameraPosition = AgentGetPos("Arizzblefreecam");
        local SaveCameraRotation = AgentGetRot("Arizzblefreecam");
        inputText = "CAMERA MODE\nPOS: " .. VectorToString(SaveCameraPosition) .. "\nROT: " .. VectorToString(SaveCameraRotation);
        if GetTotalTime() > modeSwitchTime then 
            if Input_IsVKeyPressed(1) then --left mouse button
                ...
                save_data.camera.rot_y = Arizzble_FreecamTools_InputMouseAmountX;
                save_data.camera.rot_z = SaveCameraRotation.z;
                modeSwitchTime = GetTotalTime() + 0.3;
            elseif Input_IsVKeyPressed(2) then --right mouse button
                ...
                save_data.camera.rot_to_y = Arizzble_FreecamTools_InputMouseAmountX;
    ...
    elseif input_Swith == 3 then --move_to input
        ...
        if Input_IsVKeyPressed(38) then
            if Input_IsVKeyPressed(16) then
            x_x_x = x_x_x + change_position_fast;
            elseif Input_IsVKeyPressed(18) then
        ...
        --arrow_down
        if Input_IsVKeyPressed(40) then
            if Input_IsVKeyPressed(16) then
            x_x_x = x_x_x - change_position_fast;
            elseif Input_IsVKeyPressed(18) then
            r_x_x = r_x_x + change_angle;
        ...
        --arrow_right
        if Input_IsVKeyPressed(39) then
            if Input_IsVKeyPressed(16) then
        ...
        --arrow_left
        if Input_IsVKeyPressed(37) then
            if Input_IsVKeyPressed(16) then
            z_z_z = z_z_z - change_position_fast;
            elseif Input_IsVKeyPressed(18) then
            r_y_y = r_y_y - change_angle;
        ...
        --plus
        if Input_IsVKeyPressed(107) or Input_IsVKeyPressed(187) then
            if Input_IsVKeyPressed(16) then
        ...
        --minus
        if Input_IsVKeyPressed(109) or Input_IsVKeyPressed(189) then
            if Input_IsVKeyPressed(16) then
            y_y_y = y_y_y - change_position_fast;
            elseif Input_IsVKeyPressed(18) then
            r_z_z = r_z_z + change_angle;
        ...
        AgentSetWorldPos("Dummy_2", Dummy2Pos, Custom_CutsceneDev_SceneObject);
        AgentSetWorldRot("Dummy_2", Dummy2Rot, Custom_CutsceneDev_SceneObject);
        ...
        AgentSetWorldPos("Dummy_2", Vector(-1000, -1000, -1000), Custom_CutsceneDev_SceneObject);
    ...
    --animation_input
    --SPACE
    if Input_IsVKeyPressed(32) and animation_menu == 0 then
        if mode ~= 2 then
            AnimationPrewierPlay();
        end
        animation_menu = 1;
    ...
    --ENTER
    if Input_IsVKeyPressed(13) and animation_menu == 1 then
        ResetAnimation();
        animation_menu = 0;
        root_reset = 0;
    end
    ...
    --mode
    --X
    if Input_IsVKeyPressed(84) then
        if GetTotalTime() > modeSwitchTime then
            mode = mode + 1;
            if mode > 2 then
                mode = 0;
    ...
    if Input_IsVKeyPressed(70) and GetTotalTime() > modeSwitchTime then --press F to play voice line
